  ...
  <div>
    <Row>
      ...
      <Card>
        ...
        <p>查询结果:</p>
        <Textarea :data="Analysis_result"></Textarea>
        <br>
        <br>
        ...
        <Button type="success" icon="ios-redo" @click.native="advisor_sql()">分析</Button>
        <Button type="success" icon="ios-redo" @click.native="advisor_save()">保存</Button>
        <br>
        <br>
  ...
  components: {
    ...
    methods: {
        ...
        axios.put(`${util.url}/adviorsql`, {
          ...
          .then(res => {
            if (res.data['error']) {
              ...
              this.Analysis_result = res.data['analysis_result']
            }
          })
          .catch(error => {
      ...
      advisor_save () {
        ...
        axios.post(`${util.url}/adviorsql`, {
          'sql': this.formItem.textarea,
          'analysis_result': this.formItem.analysis_result,
          'address': JSON.stringify(address)
        })
          .then(res => {
            if (res.data['error']) {
